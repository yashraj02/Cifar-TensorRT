...
const std::string gSampleName = "TensorRT.sample_onnx_cifar";
...
bool SampleOnnxMNIST::verifyOutput(const samplesCommon::BufferManager& buffers)
{
	...
	sample::gLogInfo << "Harcoded Frog:" << std::endl;
...
samplesCommon::OnnxSampleParams initializeSampleParams(const samplesCommon::Args& args)
{
    ...
    params.onnxFileName = "cifar10_on.onnx";
    params.inputTensorNames.push_back("x");
    params.outputTensorNames.push_back("Identity");
...
{
    std::cout
        << "Usage: ./sample_cifar_mnist [-h or --help] [-d or --datadir=<path to data directory>] [--useDLACore=<int>]"
        << std::endl;
...
int main(int argc, char** argv)
{
    ...
    sample::gLogInfo << "Building and running a GPU inference engine for Onnx Cifar10" << std::endl;
